...
export default function contactUs() {
    ...
    return (
        <div className="relative bg-[#050a2e] text-white ">
        ...
        <div className="text-center pt-3 sm:pt-1 sm:text-4xl font-bold">CONTACT US</div>
        <div className="container mx-auto flex flex-col sm:flex-row sm:flex-wrap justify-between items-center py-8 px-20 mt-20">
